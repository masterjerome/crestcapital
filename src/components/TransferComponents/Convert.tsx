...
const Convert = () => {
  ...
  return (
    <main>
      <p className="text-sm lg:text-base text-[#06121B] font-semibold my-4">
        Convert Amount
      </p>
      <div className=" flex flex-col gap-y-5 2xl:gap-y-0 2xl:flex-row 2xl:justify-between 2xl:items-center">
        <div className="relative min-w-[14rem] 2xl:w-[39%] cursor-pointer">
          <div
            className=" bg-[#EBEBF52E] p-3 border border-[#7676801F] flex items-center justify-between rounded-lg"
            onClick={openModal1}
          >
            <p className="text-xs 2xl:text-sm text-[#B2B3BA]">From:</p>
            <div className="flex items-center gap-x-1">
              <Image src={beforeFlag} alt="German Flag" />
              <p className="font-medium text-[12px] md:text-[14px] xl:text-[16px]">
                {beforeCountry}
              </p>
              <ArrowDown2
                size="20"
                className={`${modalOpen1 && "rotate-180"} duration-200`}
              />
            </div>
          </div>
          <div className="bg-[#EBEBF52E] p-3 border border-[#7676801F] flex justify-between items-center mt-4 rounded-lg">
            <div className="w-[80%] flex flex-col gap-y-1">
              ...
              <input
                ...
                onChange={(e: any) => {
                  setToConvertAmount(e.target.value);
                }}
                name="convertAmount"
                id="convertAmount"
            ...
            <p className="text-[10px] md:text-[12px] xl:text-[14px] text-secondary font-semibold">
              {beforeCountrySymbol}
            </p>
          </div>
          {modalOpen1 && (
        ...
        <div className="relative min-w-[14rem] 2xl:w-[39%] cursor-pointer">
          ...
          >
            ...
            <div className="flex items-center gap-x-1">
              ...
              <ArrowDown2
                size="20"
                className={`${modalOpen && "rotate-180"} duration-200`}
              />
            </div>
          </div>
          <div className="bg-[#EBEBF52E] p-3 border border-[#7676801F] flex justify-between items-center mt-4 rounded-lg">
            <div className="w-[80%] flex flex-col gap-y-1">
              <p className="text-xs 2xl:text-sm text-[#B2B3BA]">
                Recipient gets:
              </p>
              <p className="text-lg xl:text-xl font-semibold py-2 md:py-3">
                {convertedAmount}
              </p>
            </div>
            <p className="text-[10px] md:text-[12px] xl:text-[14px] text-secondary font-semibold">
