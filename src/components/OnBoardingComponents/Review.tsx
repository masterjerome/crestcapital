  ...
  return (
    <main>
      ...
      <div className="font-medium text-xs sm:text-sm xl:text-base mt-10">
        <p>
          We have received your application and It is being reviewed. You will
          receive an email after review. If your application is accepted you can
          proceed to log in.
          <br />
          <br /> This might take 1 - 3 business days.
        </p>
      </div>
    </main>
  );
